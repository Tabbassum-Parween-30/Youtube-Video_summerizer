...
def generate_notes(transcript_text, subject):
    if subject == "Physics":
        ...
        prompt = """
            Title: Detailed Current Affairs Notes from YouTube Video Transcript

            As a Current Affairs expert, your task is to provide detailed notes based on the transcript of a YouTube video I'll provide. Assume the role of a student and generate comprehensive notes covering the key Current Affairs concepts discussed in the video.

            Your notes should:

            - Outline Current Affairs problems, concepts, problem-solving, important messages techniques covered in the video.
            - Provide step-by-step explanations about every problems discussed.
            - Clarify any theoretical foundations or historical principles underlying the discussed topics.
            - Include relevant examples and the effect on the coming world to reinforce understanding.

            Please provide the YouTube video transcript, and I'll generate the detailed Current Affairs notes accordingly.
        """
    elif subject == "General Knowledge":
        prompt = """
            Title: Detailed Notes from YouTube Video Transcript

            As an expert, your task is to provide detailed notes based on the transcript of a YouTube video I'll provide. Assume the role of a student and generate comprehensive notes covering the key concepts discussed in the video.

            Your notes should:

            - Outline the major concepts, techniques covered in the video.
            - Provide step-by-step explanations for problems, concepts discussed.
            - Clarify any theoretical foundations or mathematical principles underlying the discussed topics.
            - Include relevant examples or practice problems to reinforce understanding.

            Please provide the YouTube video transcript, and I'll generate the detailed notes accordingly.
        """
    elif subject == "History":
        prompt = """
            Title: Detailed History Notes from YouTube Video Transcript

            As a History expert, your task is to provide detailed notes based on the transcript of a YouTube video I'll provide. Assume the role of a student and generate comprehensive notes covering the key Historical concepts discussed in the video.

            Your notes should:

            - Outline the major concepts, historocal time frame, works, achievements, changes covered in the video.
            - Provide step-by-step explanations for concepts, historocal time frame, works, achievements, changes discussed.
            - Clarify any theoretical foundations or historical principles underlying the discussed topics.
            - Include relevant examples or present time scenatio on that historical concepts to reinforce understanding.

            Please provide the YouTube video transcript, and I'll generate the detailed Historical notes accordingly.
        """
    elif subject == "Games":
        prompt = """
            Title: Detailed Games Notes from YouTube Video Transcript

            As a Games expert, your task is to provide detailed notes based on the transcript of a YouTube video I'll provide. Assume the role of a student and generate comprehensive notes covering the key Games concepts discussed in the video.

            Your notes should:

            - Outline the major concepts, techniques covered in the video.
            - Provide step-by-step explanations for concepts, techniques discussed.
            - Clarify the achievements on the game, the history of the game underlying the discussed topics.
            - Include relevant examples and achievements to reinforce understanding.
...
def main():
    ...
    subject = st.selectbox("Select Subject:", ["Physics", "Chemistry", "Mathematics", "Data Science and Statistics" , "General Knowledge" , "Current Affairs" , "History" , "Games"])
